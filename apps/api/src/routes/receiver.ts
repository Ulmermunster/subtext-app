...
(function(){
  ...
  function checkSpotifySession() {
    fetch(API + '/auth/me', { credentials: 'include' })
      ...
      .then(function(me) {
        ...
        if (isMobileBrowser) {
          // Mobile: use Spotify Connect API (controls the Spotify app)
  ...
  function startPlayback() {
    ...
    // Option 2: Mobile Connect playback (controls Spotify app)
    ...
    // Option 3: Fallback preview audio
    playPreviewAudio();
  }
