              ...
              <div className="flex flex-col gap-3 w-full max-w-xs">
                ...
                <div className="flex gap-3 w-full">
                  <button
                    ...
                    className={`flex-1 rounded-full py-3 text-sm font-bold text-white min-h-[48px] active:scale-95 transition-all ${
                      discoveryVibe === 'VIBE' ? 'ring-[3px] ring-emerald-400/40' : ''
                    }`}
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-full py-3 text-sm font-bold text-white min-h-[48px] active:scale-95 transition-all ${
                      discoveryVibe === 'NOPE' ? 'ring-[3px] ring-orange-400/40' : ''
                    }`}
